...
if(time() - $token["date"] > 3599) {
	...
	$credentials = file_get_contents("credentials.auth"); // create file "credentials.auth" and insert your credentials in the format "clientid:clientsecret" (without quotation marks), ex. "123:abc"
